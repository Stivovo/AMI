...
ExternalProject_get_property(LIBZIP SOURCE_DIR)
set(LIBZIP_SOURCE_DIR "${SOURCE_DIR}")
set(LIBZIP_LIBRARIES
  "${LIBZIP_SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}zip${CMAKE_STATIC_LIBRARY_SUFFIX}")
message(STATUS "${LIBZIP_LIBRARIES}")
message(STATUS "Install dir: ${LIBZIP_INSTALL_DIR}")
